...
var resolveCatalogUrlFromWebId = /*#__PURE__*/function () {
  var _ref19 = _asyncToGenerator(function* (webId, fetch) {
    ...
    try {
      ...
      var profileCatalog = profileThing ? getUrl(profileThing, DCAT.catalog) : null;
...
var DatasetAddModal = _ref => {
  ...
  var [datasetPodFiles, setDatasetPodFiles] = useState([]);
  var [modelPodFiles, setModelPodFiles] = useState([]);
  ...
  var [datasetUploadPath, setDatasetUploadPath] = useState("/public/");
  var [modelUploadPath, setModelUploadPath] = useState("/public/");
  var [datasetType, setDatasetType] = useState("dataset");
        ...
        var _traverse = /*#__PURE__*/function () {
          var _ref4 = _asyncToGenerator(function* (containerUrl) {
            try {
              ...
              var dataset = yield getSolidDataset(containerUrl, {
                fetch: session.fetch
              });
              var resources = getContainedResourceUrlAll(dataset);
...
var DatasetDetailModal = _ref2 => {
  ...
  var [showSemanticModal, setShowSemanticModal] = useState(false);
        ...
        try {
          ...
          var _traverse = /*#__PURE__*/function () {
            var _ref3 = _asyncToGenerator(function* (containerUrl) {
              try {
                if (isCatalogResource(containerUrl)) return;
                var _dataset = yield getSolidDataset(containerUrl, {
                  fetch: session.fetch
                });
                var resources = getContainedResourceUrlAll(_dataset);
    ...
    var _ref2 = _asyncToGenerator(function* () {
      ...
      try {
        ...
        try {
          ...
          if (catalogResolved) {
            yield getSolidDataset(catalogResolved.split("#")[0], {
              fetch: session.fetch
            });
            hasCatalog = true;
          }
