...
def populate_db(db: Session):
    ...
    dataset1 = DatasetCreate(
        ...
        is_public=True,
        file_path="C:/Users/Florian Hölken/source/repos/solid-server/data/server1/testpod1s1/temperature_data_1.csv",
        owner_id=person1.id,
    ...
    dataset2 = DatasetCreate(
        ...
        is_public=True,
        file_path="C:/Users/Florian Hölken/source/repos/solid-server/data/server2/testpod1s2/temperature_data_2.csv",
        owner_id=person2.id,
